 ...
 */
class GetPalladiumStats extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('Statistiques Palladium (Periode ci dessus !)');
        $this->dimension     = null;
    ...
    {
        $view->config->columns_to_display = array('Total des ventes',"En 3G","En wifi","Installations facteurs","Offres postier","Prepayés wifi","Prépayés 3g");
    }
